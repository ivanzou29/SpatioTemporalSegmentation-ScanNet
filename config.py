...
train_arg.add_argument('--save_freq', type=int, default=4000, help='save frequency')
train_arg.add_argument('--val_freq', type=int, default=4000, help='validation frequency')
train_arg.add_argument('--val_train_freq', type=int, default=4000, help='training set evaluation frequency')
...
train_arg.add_argument('--focal_loss_gamma', type=float, default=1.0)
